    ...
    <div className="min-h-screen p-8 animate-fade-in">
      ...
      <Card className="glass-effect max-w-4xl">
        <CardHeader>
          ...
          <CardDescription>
            Enter all the necessary information for your event
          </CardDescription>
        </CardHeader>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                ...
                <TimeSelect
                  ...
                  onHourChange={(v) => handleChange("startHour", v)}
                  onMinuteChange={(v) => handleChange("startMinute", v)}
                  hours={hours}
                  minutes={minutes}
                />
                ...
                <TimeSelect
                  ...
                  onHourChange={(v) => handleChange("endHour", v)}
                  onMinuteChange={(v) => handleChange("endMinute", v)}
                  hours={hours}
                  minutes={minutes}
                />
              </div>
            ...
            <div className="flex gap-4 border-t pt-6">
              <Button
                type="submit"
                disabled={loading}
                className="gradient-primary h-12 flex-1 text-base font-semibold text-white shadow-glow"
              >
